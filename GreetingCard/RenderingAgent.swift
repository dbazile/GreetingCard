...
class RenderingAgent
{
	...
	///
	func render(scene: Scene, onCanvas canvas: UIView) -> RenderingAgent
	{
		return render(scene, withHighlightIndex: nil, onCanvas: canvas)
	}
	...
	///
	func render(scene: Scene, withHighlightIndex: Int?, onCanvas canvas: UIView) -> RenderingAgent
	{
		...
		for layer in scene.layers {
			...
			if (currentIndex == withHighlightIndex) {
